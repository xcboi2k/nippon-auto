...
export default function VehicleListingCreateScreen() {
    const navigation =
            ...
            <ScrollView>
                <View className="w-full px-[30px] mt-[10px] mb-[15px]">
                        ...
                        <View className="w-full flex flex-row items-center p-[8px]">
                            {transmissionItems.map((item) => (
                                <TouchableOpacity
                                    key={item.itemID}
                                    onPress={() =>
                                        setSelectedTransmission(item.itemName)
                                    }
                                    className={`w-[72px] h-[48px] rounded-[5px] items-center justify-center m-[5px]
                                    ${selectedTransmission === item.itemName ? 'bg-[#234791]' : 'bg-[#F4F6F8]'} p-[5px]`}
                                >
                                    <Text
                                        className={`text-[12px] text-center ${selectedTransmission === item.itemName ? 'text-[#F4F6F8]' : 'text-[#234791]'}`}
                                    >
                                        {item.itemName}
                                    </Text>
                                </TouchableOpacity>
                        ...
                        <View className="w-full flex flex-row items-center p-[8px]">
                            {classificationItems.map((item) => (
                                <TouchableOpacity
                                    key={item.itemID}
                                    onPress={() =>
                                        setSelectedClassification(item.itemName)
                                    }
                                    className={`w-[72px] h-[48px] rounded-[5px] items-center justify-center m-[5px]
                                    ${selectedClassification === item.itemName ? 'bg-[#234791]' : 'bg-[#F4F6F8]'} p-[5px]`}
                                >
                                    <Text
                                        className={`text-[12px] text-center ${selectedClassification === item.itemName ? 'text-[#F4F6F8]' : 'text-[#234791]'}`}
                                    >
                                        {item.itemName}
                                    </Text>
                                </TouchableOpacity>
                    ...
                    <CommentInput
                        inputProps={{
                            placeholder:
                                'Make a short description about the vehicle',
                    ...
                    <View className="w-full mb-[15px]">
                        ...
                        <View className="w-full flex flex-row items-center p-[8px] mb-[10px]">
                            ...
                            >
                                <Text
                                    className={`text-[12px] text-center ${isRegistered === 'Yes' ? 'text-[#F4F6F8]' : 'text-[#234791]'}`}
                                >
                                    Yes
                                </Text>
                            </TouchableOpacity>
                            ...
                            >
                                <Text
                                    className={`text-[12px] text-center ${isRegistered === 'No' ? 'text-[#F4F6F8]' : 'text-[#234791]'}`}
                                >
                                    No
                                </Text>
                            </TouchableOpacity>
